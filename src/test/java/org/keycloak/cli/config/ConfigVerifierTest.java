...
//                "mycontext",
//                true,
//                Map.of("myissuer", new Config.Issuer("https://issuer", Map.of("mycontext", new Config.Context("myissuer", Flow.PASSWORD, new Config.Client("myclient", null), new Config.User("myuser", "myuserpassword"), null)),
//                null);
...
//
//        context.setIssuer("nosuch");
//        assertContextError("mycontext", "issuer ref 'nosuch' not found");
//    }
//
//    @Test
