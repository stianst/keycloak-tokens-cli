...
public class ContextViewTest {
    ...
    public void testViewDefaultContext(QuarkusMainLauncher launcher) {
        ...
        LauncherAssertions.assertYamlOutput(result, "test-service-account", ConfigTestProfile.DEFAULT_CONFIG.issuers().get("test-issuer").contexts().get("test-service-account"));
    }
    ...
    public void testViewSpecifiedContext(QuarkusMainLauncher launcher) {
        ...
        LauncherAssertions.assertYamlOutput(result, "test-password", ConfigTestProfile.DEFAULT_CONFIG.issuers().get("test-issuer").contexts().get("test-password"));
    }
